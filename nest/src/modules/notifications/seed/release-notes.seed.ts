...
export const RELEASE_NOTES: readonly ReleaseNoteSeed[] = [
  ...
  // 2.7.0 в прод не выходила вовсе; 2.7.1 вышла — её строка и `.md` остаются жить на сервере
  // (персистентный content/), поэтому кто ноту уже читал, откроет её и дальше. Новый номер = новый
  // ключ = новый бродкаст: людям есть что сообщить.
  {
    key: 'release-2.7.2',
    title: 'Нормисы 2.7.2 — «Препятствия», минимум на плохой день и свежесть между устройствами',
    contentFile: 'notifications/release-2.7.2.md',
  },
];
