...
- **Закрытие 2.6.2:** [x] feature-file синхрон; [x] релиз-нота `release-2.6.2.md` + `RELEASE_NOTES` (`release-2.6.2`); [x] `VERSION`→`2.6.2`; [ ] tsc/prod-build; [ ] браузер-verify; [ ] деплой (бандлом с 2.6.1). _(Миграций нет.)_
