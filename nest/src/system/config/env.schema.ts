...
export const envSchema = z.object({
  ...
  // ── Роли и админка (2.9.3) ──
  // Логины администраторов через запятую. Пусто по умолчанию — случайных админов не бывает.
  // Роли только ВЫДАЮТСЯ: убрали логин отсюда — права остаются, снятие роли это осознанное
  // действие админки, а не побочный эффект правки переменной.
