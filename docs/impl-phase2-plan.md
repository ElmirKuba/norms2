...
- [ ] **·6 (API)** — `GET /accent/stats` (постоянство общее и по привычкам, достижения выданные и невыданные, «возвращался N раз») + досыпка полей постоянства в `GET /accent/dashboard`. Контракт — в `api-contracts.md` **в том же шаге**.
