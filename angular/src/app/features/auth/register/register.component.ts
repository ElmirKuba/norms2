...
export class RegisterComponent {
   ...
   *
   * Берётся из публичной конфигурации, загруженной на старте: своего запроса экран не делает.
   * Бот не настроен — строки про заявку просто не будет.
   */
  protected readonly botUrl = this._flags.botUrl;
