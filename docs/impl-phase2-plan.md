...
- [ ] **·15 (релиз)** — feature-файл как черновик ноты → `VERSION`→`2.7.3`, нота `release-2.7.2.md` → `release-2.7.3.md` (файл + `key` + `title`) + новый раздел, **уборка осиротевших `release-2.6.x` на прод-томе**, деплой + smoke.
