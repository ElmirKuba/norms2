...
- [ ] **·1 (docs)** — контракт `GET /accent/dashboard` (состав снимка, форма «Сейчас», флаги онбординга) + [`ui-ux §5`](./sections/accent/ui-ux.md) приведён к факту: что собираем в 2.11, что приходит позже и с какой подфазой.
