...
/**
 * VO текста секретного вопроса (свой текст, ADR-0008). Нормализуется (trim + схлоп
 * пробелов) и валидируется по длине. Серверного чёрного списка тем НЕТ (реш. #3,
 * ADR-0046): на free-text он хрупок/обходится, а ответ хешируется — вместо запрета
 * мягкая UI-подсказка в форме.
 */
