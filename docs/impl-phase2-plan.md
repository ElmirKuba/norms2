...
- [ ] **·8 (бэк, реверс лесенки)** — `uncomplete`: граница **«только сегодняшняя задача»** (иначе 400, как у `unpostpone`) + восстановление лесенки из снимка через тот же CAS с повтором, снимок гасим. **API-смоук:** отметил → планка выросла → отменил → вернулась; вчерашнюю отменить нельзя.
