...
- [ ] **·5 (фронт, сводка)** — блоки под героем: задачи дня (% + короткий список), цели, «Держусь», просрочка, строка «накрыло? → Столкнулся» (если у человека есть свои препятствия). Пустые блоки не рисуем вовсе.
