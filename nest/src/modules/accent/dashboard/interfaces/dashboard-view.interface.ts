...
export interface DashboardView {
  ...
  /**
   * Только что пройденная веха «держусь» или null (2.9·15). Того же класса, что
   * `freshAchievement`: событие на пару дней, не постоянный блок. Показываем **одну, старшую** —
   * догнав 3 и 7 дней разом, человек должен увидеть «неделю», а не череду строк об одном.
   */
