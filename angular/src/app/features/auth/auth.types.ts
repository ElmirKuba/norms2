...
export interface CheckInviteResponse {
  valid: boolean;
  /**
   * Подпись, с которой пригласивший создавал код, или null.
   * Показывается на экране приглашения: без неё экран безличный — человек видит факт
   * приглашения, но не видит, кем и зачем он тут нужен.
   */
  reason: string | null;
}
