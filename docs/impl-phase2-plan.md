...
#### 2.7.3 — деталь привычки: «что было с этой привычкой» — 📋 ДИЗАЙН, решений нет
...
**Следующий шаг:** разбор в 3 шляпы + ответы на **A/B/C** (и **F**, если решим показывать
агрегаты) → только потом нарезка на под-шаги и, если пойдём через события, ADR.
