 ...
 * 3. **жёсткие таблицы — ровно те шесть, что разобраны в ADR.** Список короткий, и каждое
 *    добавление в него обязано быть осознанным: это единственные места, где данные исчезают.
 */
describe('режим удаления таблиц (ADR-0068)', () => {
  ...
  it('жёсткие — ровно шесть перечисленных, остальные мягкие', () => {
