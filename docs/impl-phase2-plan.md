...
- **💡 КОНЦЕПТ НА ПОДУМАТЬ (Elmir, 2026-08-01) — «Открыть „Сегодня“ за выбранную дату».** Не в
  ...
  - **Как назвать — открыто, но важно: имя задаёт границы фичи.** Elmir забраковал «Открыть
    ...
    **«Забыл отметить?»** (называет ситуацию человека, рамка узкая — выбор Claude), «Другой день»
    (нейтрально), «Вчера и раньше» (ограничение видно прямо в названии). Решает Elmir.
