...
- [ ] **·14 (verify)** — браузер-verify на dev (лента, перенос одним объектом, пустой стейт, реверс лесенки), `make audit-fields`, `tsc`, prod-build.
...
7. ~~**Причина пропуска `cancelled` была мертва**~~ — объявлена в типе и не писалась никогда.
