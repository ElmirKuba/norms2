...
### `Account` (корень)
Поля (доменный вид): `id`, `login: Login`, `alias: Alias`, `passwordHash`, `registrationSource: free|invite|seed`, `invitesRemaining`, `recoveryRequiredCount?`, `deactivatedAt?`, `deletedAt?`.
Инварианты:
