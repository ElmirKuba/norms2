...
- [ ] **·2 (бэк, домен «Сейчас»)** — правила приоритета в отдельном domain-service: просрочка → задача дня → микро-победа → похвала. Чистая функция над готовыми данными, без своих запросов к БД сверх нужного.
