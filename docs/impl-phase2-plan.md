...
- [ ] **2.7·26** Связь с «Держусь»: в модалке рецидива — выбор препятствия (`obstacleId`), на детали
  препятствия — «сорвался из-за этого N раз»; бэк: `obstacle_id` в `anti_habit_events` (миграция) +
  проброс в DTO/view.
