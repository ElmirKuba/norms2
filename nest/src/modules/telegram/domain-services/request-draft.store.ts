 ...
 * админ знает по аккаунту. Спрашивать их заново — собирать личные данные без повода.
 */
 ...
 * Запись в базу появляется **в момент отправки админу** и содержит карточку без текста.
