...
export interface InviteeNode {
  ...
  bannedByMe: boolean;
  /**
   * Удалён ли участник (2.9.3·24).
   *
   * Узел остаётся в дереве и после удаления аккаунта — иначе его приглашённые повисли бы в
   * воздухе. Но выглядеть он должен иначе: человека уже нет.
   */
  deleted: boolean;
}
