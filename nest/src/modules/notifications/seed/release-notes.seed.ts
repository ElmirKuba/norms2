...
export const RELEASE_NOTES: readonly ReleaseNoteSeed[] = [
  ...
  // Версия 2.7.0 в прод не выходила — её ключ и файл нигде не развёрнуты, поэтому переименование
  // безболезненно (в отличие от линии 2.6.x, где старые копии живут на сервере).
  {
    key: 'release-2.7.1',
    title: 'Нормисы 2.7.1 — «Препятствия», минимум на плохой день и свежесть между устройствами',
    contentFile: 'notifications/release-2.7.1.md',
  },
];
