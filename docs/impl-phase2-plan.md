...
- **R1 ЗАВЕРШЁН** (R1a финализация + R1b аудит). Аудит нашёл и закрыл 3 расхождения:
  ...
  **Текущая прод-версия — 2.5.1.** Следующее по плану раздела — подфаза `2.6` (AntiHabit «держусь»).- Частичные правки уже применены по ходу (структурные следствия merge/нумерации):
...
- **2.5·28 (РЕГРЕСС ВСЕГО АКЦЕНТА перед деплоем) — реш. Elmir (2026-06-24): не только цели, а ещё привычки
  ...
  - **Фаза C — совместный прогон + фикс (Elmir кликает, я смоучу/сверяю БД):**
    ...
    - [x] **·28.C — карта «Привычки» пройдена ✅ (2026-06-29)** ([test-map-habits.md](./test-map-habits.md)) — зелёная (A–G).
    - [x] **·28.C — карта «Цели» пройдена ✅ (2026-06-29)** ([test-map-2.5-goals.md](./test-map-2.5-goals.md)) — зелёная (A–J).
