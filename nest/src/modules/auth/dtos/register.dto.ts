...
export const registerSchema = z
  .object({
    ...
    // Часовой пояс устройства (2.10·A1): строка IANA вроде `Asia/Yekaterinburg`. Формат тут не
    // проверяем списком — существование зоны сверяет домен через `Intl`, потому что справочник
    // в коде протухает, а зоны меняются политическими решениями.
