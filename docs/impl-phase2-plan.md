...
- [ ] **2.7·35** Фронт: на `pending`-карточке с привязкой — кнопка **«Минимум сегодня: 1 отжимание ▶»**
  (таймер микро-победы → `complete-minimum` → бейдж «Частично N»); в формах привычки и цели — опц.
  селект «минимум на плохой день» из своих микро-побед; на карточке микро-победы — «служит минимумом
  для: …».
