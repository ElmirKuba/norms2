...
export class AccentHabitDomainService {
   ...
   */
  public async list(accountId: string, archived = false): Promise<HabitFull[]> {
   ...
   * @throws {HabitNotFoundError} Если чужое или не существует.
   */
  public async setArchived(id: string, accountId: string, archived: boolean): Promise<HabitFull> {
