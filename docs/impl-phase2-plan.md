...
- [ ] **F1 (docs)** — синхрон `api-contracts §5`: новое поведение `complete` (понижение значения только с явным `replace`, иначе `409` с актуальной задачей) + колонка `updated_at` у задач.
