...
- [ ] **E5 [Elmir]** — приёмка страницы глазами.
...
- [ ] **E7 [Elmir]** — **приёмка превью**. Claude картинки **не открывает** (битое изображение в контексте валит запросы и жжёт лимиты): генерирует вслепую, смотрит Elmir, правки вносятся по словам.
