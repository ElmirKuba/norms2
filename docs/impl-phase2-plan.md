...
- [ ] **·4.5 + E6 [вместе]** — выбрать инструмент: MCP-дизайн (нужно подключить и авторизовать — рабочих у Claude сейчас нет) **или** свой генератор на HTML + headless Chrome (уже стоит, единый стиль с продуктом, перерисовка всех разом) **или** Figma руками у Elmir.
- [ ] **·4.6** — генератор превью 1200×630 + `make previews`.
