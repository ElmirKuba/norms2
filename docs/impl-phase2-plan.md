...
- [ ] **2.7·36** Verify блока H: API (валидация чужой/несуществующей ссылки → 400; `complete-minimum`
  → лог + partial + серия держится; SET NULL при удалении микро-победы) + браузер-клик + prod-build.
