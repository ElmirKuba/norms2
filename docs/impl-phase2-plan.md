...
- **R1 ЗАВЕРШЁН** (R1a финализация + R1b аудит). Аудит нашёл и закрыл 3 расхождения:
  ...
  **2.1 в работе (НЕ продим — делаем локально поэтапно, выкатим бандлем с 2.2):
  2.1·1 ✅ (таблицы accent_domains/accent_attributes, миграция 0004 на dev).
  Следующее — `2.1·2` (AccentReferenceModule: порт + Drizzle-репо listDomains/listAttributes).**
