...
- **Чего в снимке пока нет** (придёт со своими подфазами, дашборд аддитивен): `state`/`recommendations` и быстрый чек-ин — 2.8; `week` (donut/бары/лучший-худший) — 2.10; XP, уровень, серии, достижения — 2.9; тренды самочувствия — 2.8.
