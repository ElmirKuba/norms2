...
#### 2.11 — дашборд «кокпит» → выйдет версией `2.8.0` — 🔄 разобрано, решения приняты, кодинг не начат
