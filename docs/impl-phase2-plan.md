...
- [ ] **·3 (бэк, агрегатор)** — use-case + `GET /accent/dashboard` + проекция: «Сейчас», задачи дня с процентом, цели (фокусные первыми), «Держусь», просрочка, флаги онбординга, состояние паузы. Кросс-домен **вниз** через domain-services. **API-смоук на dev**, включая пустой аккаунт.
