...
- [ ] **F5 (фронт, «Сегодня» + 409)** — подключить обновление на экране задач дня; обработка `409`: берём актуальную задачу из тела, патчим карточку, мягкое «уже отмечено на другом устройстве», **без ручной перезагрузки**.
