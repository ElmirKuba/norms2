...
#### 2.7.1 — свежесть данных между устройствами — ⬜ не начато, идёт ПОСЛЕ 2.7.0
...
- [ ] **F7 (релиз)** — `VERSION`→`2.7.1`, раздел в ноте линии 2.7 (`release-2.7.0.md` → переименовать файл/ключ на `release-2.7.1`), деплой + smoke.
