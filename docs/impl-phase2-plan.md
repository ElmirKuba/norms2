...
- [ ] **·7 (фронт, дашборд)** — плитка постоянства в бенто-сетке: итог крупно, окно рядом мелким индикатором (та же типографская иерархия, что отлажена в 2.11). Не забыть `padding: var(--space-4) 0` — забывалось дважды.
