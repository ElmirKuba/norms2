...
- ✅ 7. `LadderEngine` — едет с Привычками (2.0.3); очки за ladder — 2.0.8
...
- **Уточнение карты:** `LadderEngine` (подъём/откат планки) — механика Привычек (2.0.3),
  работает без очков; очки за `ladder.raised` — в геймификации (2.0.8).
...
- Добавлен **ядровый принцип «Самокомандование»** (Elmir): план задаёшь в ясном
  ...
  (commitment device / автономия). **Влияет на:** `Recommender` (2.0.7) — отдаёт
  директивную «команду сейчас», и **дашборд** (2.0.10) — не пассивный список, а ясное
