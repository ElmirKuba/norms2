...
> **Осталось (код) для 2.6/«держусь»:** Трек C — **C2 ✅ закрыт** (БД: схемы+миграция 0026+репозитории, накатано на dev); далее C3–C5 (домен/API/фронт/verify). Начинать с первого незакрытого `[ ]` (C3.3 DTO — C3.1/C3.2 частично сделаны в C2).
