...
- **R1 ЗАВЕРШЁН** (R1a финализация + R1b аудит). Аудит нашёл и закрыл 3 расхождения:
  ...
  **2.3 НАРЕЗАНА на шаги ·1–·6:** ·1 ✅ (БД is_starter + демонтаж авто-сева 2.2·5, миграция 0007);
  ...
  ·1 ✅ (БД+демонтаж), ·2 ✅ (бэк), ·3 ✅ (API), ·4 ✅ (фронт пака/badge/adoption), ·5 ✅ (мотив-
  callout «для тяжёлых дней»). **Следующее — `2.3·6` (деплой 2.3.0: release-2.3.0.md + broadcast,
  prod-build/up, smoke).** Детальная секция ниже.**
