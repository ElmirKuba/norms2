...
#### 2.7.3 — деталь привычки: «что было с этой привычкой» — ✅ РАЗОБРАНО, нарезано (15 шагов), кодинг не начат
