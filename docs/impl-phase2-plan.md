...
- **`2.5.x`-патчи целей (мелкие, до/после деплоя 2.5):** правка/удаление записи прогресса (патч 8 — делается), график прогресса на детали.
...
- [x] **2.5·23 (ретро 2.5 в 3 шляпы) — ЗАКРЫТ ✅** → [docs/retro-phase2-2.5.md](./retro-phase2-2.5.md).
  ...
  **+ FIX-ПРОХОД (Elmir «фиксим все», 2026-06-23): исправлено 8/8 находок** (P1 fallbackVersion виден ·
  ...
  P3#6 reduce-тон · P3#7 rollup/записи не смешиваются · P3#8 forecast-хинт). Таблица «Резолюция находок» —
  в retro-doc. Миграции до **0016**. Весь fix-проход — boot/live/prod-сборки зелёные.
