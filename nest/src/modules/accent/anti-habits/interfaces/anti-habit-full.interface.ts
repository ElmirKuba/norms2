...
export interface AntiHabitFull {
  ...
  /** Стартовый пример (`is_starter`, ADR-0051): виден с бейджем «пример», но инертен (не
   * считает серию/цели, не принимает рецидив/перенос) до присвоения («Добавить себе»/«Изм.»). */
  isStarter: boolean;
