...
- **R1 ЗАВЕРШЁН** (R1a финализация + R1b аудит). Аудит нашёл и закрыл 3 расхождения:
  ...
  **Код: ·1 ✅ (зонтик AccentModule), ·2 ✅ (таблица accent_settings, миграция 0003 на dev),
  ...
  ·5 ✅ (меню+роут), ·6 ✅ (вкладки+дашборд с пауза-тумблером+сиды). **КАРКАС 2.0.0
  собран целиком (·1–·6). Следующее — ДЕПЛОЙ `2.0.0`** (бамп VERSION→2.0.0, прод-миграция
  0003, prod-build+up, smoke). Это первый прод-выкат фазы 2.
...
- [ ] **ДЕПЛОЙ 2.0.0** — бамп `VERSION`→`2.0.0`, прод-миграция `0003`, prod-build+up, боевой smoke. ← КАРКАС ГОТОВ, можно деплоить.
